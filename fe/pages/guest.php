...
<nav class="navbar" id="navbar">
  ...
  <div class="nav-actions">
    <a href="/fe/pages/login.php" class="btn-nav-outline">
      <i class="fa-solid fa-right-to-bracket"></i> Đăng nhập
    </a>
    <a href="/fe/pages/login.php" class="btn-nav-primary" onclick="showRegister(event)">
...
<div class="mobile-menu" id="mobile-menu">
  ...
  <div class="mobile-menu-btns">
    <a href="/fe/pages/login.php" style="display:flex;align-items:center;justify-content:center;height:52px;border:1.5px solid rgba(255,255,255,.2);border-radius:14px;color:#fff;text-decoration:none;font-size:15px;font-weight:700;gap:10px;">
      <i class="fa-solid fa-right-to-bracket"></i> Đăng nhập
    </a>
    <a href="/fe/pages/login.php" onclick="showRegister(event)" style="display:flex;align-items:center;justify-content:center;height:52px;background:linear-gradient(135deg,var(--blue),var(--violet));border:none;border-radius:14px;color:#fff;text-decoration:none;font-size:15px;font-weight:700;gap:10px;box-shadow:0 8px 24px rgba(59,130,246,.4);">
      <i class="fa-solid fa-user-plus"></i> Đăng ký miễn phí
    </a>
  </div>
</div>
      ...
      <?php foreach ($hero_movies as $index => $m): ?>
        <div class="hero-slide <?= $index === 0 ? 'active' : '' ?>" data-slide-index="<?= $index ?>">
          ...
          <div class="hero-content">
            ...
            <div class="hero-btns">
              <a href="/fe/pages/login.php" class="btn-hero-primary">
...
<section id="sec-showing">
  <div class="container">
    <div class="sec-head fade-up">
      ...
      <a href="/fe/pages/login.php" class="sec-link">
    ...
    <div class="promo-inner fade-up">
      ...
      <div class="promo-text">
        ...
        <div class="promo-btns">
          <a href="/fe/pages/login.php" onclick="showRegister(event)" class="btn-promo-primary">
            <i class="fa-solid fa-user-plus"></i> Đăng ký miễn phí
          </a>
          <a href="/fe/pages/login.php" class="btn-promo-outline">
...
<section id="sec-coming">
  <div class="container">
    ...
    <div class="coming-grid">
      ...
      <a class="coming-card fade-up" href="/fe/pages/login.php" title="<?= htmlspecialchars($m['title']) ?>">
        <?php if($m['poster_url']): ?>
...
<section id="sec-cinemas">
  <div class="container">
    ...
    <div class="cinema-grid">
      ...
      <a class="cinema-card fade-up" href="/fe/pages/login.php" title="<?= htmlspecialchars($c['name']) ?>">
...
<section id="sec-cta">
  <div class="container">
    <div class="cta-card fade-up">
      ...
      <div class="cta-btns">
        <a href="/fe/pages/login.php" onclick="showRegister(event)" class="btn-cta-primary">
  ...
  <div class="footer-inner">
    <div class="footer-grid">
      ...
      <div class="footer-col">
        <h4>Tài khoản</h4>
        <ul>
          <li><a href="/fe/pages/login.php">Đăng nhập</a></li>
          <li><a href="/fe/pages/login.php" onclick="showRegister(event)">Đăng ký</a></li>
          <li><a href="/fe/pages/login.php">Vé của tôi</a></li>
          <li><a href="/fe/pages/login.php">Tích điểm thưởng</a></li>
        </ul>
      </div>
      <div class="footer-col">
        <h4>Hỗ trợ</h4>
        <ul>
          <li><a href="/fe/pages/login.php">Trung tâm trợ giúp</a></li>
  ...
  <div id="qv-panel">
    ...
    <div id="qv-inner">
      ...
      <div id="qv-info">
        ...
        <a href="/fe/pages/login.php" id="qv-cta">
